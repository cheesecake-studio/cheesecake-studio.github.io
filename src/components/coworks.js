...
class Coworks extends Component {
  ...
  drawcoworks(){
    var coworksection1 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/covers/1.jpg" alt="book1" className="bookCoverImage"/>
      ...
      <ul className="list-inline">
        <li><a href="https://www.aladin.co.kr/shop/wproduct.aspx?ISBN=8970504745&start=pnaver_02" target="_blank"  rel="noreferrer">
          <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/stores/aladdin.png" className="coworkstoreIcon" alt="aladin"/></a></li>
        <li><a href="http://www.kyobobook.co.kr/product/detailViewKor.laf?mallGb=KOR&ejkGb=KOR&linkclassName=&barcode=9788970504742" target="_blank"  rel="noreferrer">
          <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/stores/kyobo.png" className="coworkstoreIcon" alt="kyobo"/></a></li>
        <li><a href="https://book.naver.com/bookdb/book_detail.nhn?bid=17665326" target="_blank"  rel="noreferrer">
          <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/stores/naver.png" className="coworkstoreIcon" alt="naver"/></a></li>
        <li><a href="http://www.yes24.com/Product/Goods/96360166" target="_blank"  rel="noreferrer">
          <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/stores/yes24.png" className="coworkstoreIcon" alt="yes24"/></a></li>
      </ul>
    </div>

    var coworksection2 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/covers/2.jpg" alt="book2" className="bookCoverImage"/>
      <h5>공학자의 오경묵상</h5>
    ...
    var coworksection3 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/covers/3.jpg" alt="book3" className="bookCoverImage"/>
      <h5>공학자의 지혜묵상</h5>
    ...
    var coworksection4 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/covers/4.jpg" alt="book4" className="bookCoverImage"/>
    ...
    var coworksection5 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/covers/5.jpg" alt="book5" className="bookCoverImage"/>
      <h5>법대로 합시다</h5>
    ...
    var coworksection6 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/covers/6.jpg" alt="book6" className="bookCoverImage"/>
      <h5>실전 민사소송법</h5>
      <p className="bookDescription">2020.05. BOOKK(부크크)</p>
      <ul className="list-inline">
    ...
    var coworksection7 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/covers/7.jpg" alt="book7" className="bookCoverImage"/>
      <h5>코딩하는 공익</h5>
    ...
    var coworksection8 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/covers/8.jpg" alt="book8" className="bookCoverImage"/>
    ...
    var coworksection9 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/covers/9.jpg" alt="book9" className="bookCoverImage"/>
      ...
      <ul className="list-inline">
        ...
        <li><a href="https://book.naver.com/bookdb/book_detail.nhn?bid=20764734" target="_blank"  rel="noreferrer">
          ...
          <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/stores/ridi.jpg" className="coworkstoreIcon" alt="ridicoworks"/></a></li>
      </ul>
    </div>
    
    var coworksection10 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/covers/10.jpg" alt="book10" className="bookCoverImage"/>
    ...
    var coworksection11 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/covers/11.jpeg" alt="book11" className="bookCoverImage"/>
    ...
    var coworksection12 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/covers/12.jpg" alt="book12" className="bookCoverImage"/>
    ...
    var coworksection13 = <div className="singleBookContainer">
      <img src="https://cdn.jsdelivr.net/gh/needleworm/cheesecake-studio.github.io/src/images/coworks/covers/13.jpg" alt="book12" className="bookCoverImage"/>
